...
const CATALOG_SERVICE_URL = process.env.CATALOG_SERVICE_URL || 'http://34.228.5.25:5003';
// URL of the catalog-del-service microservice
const CATALOG_DEL_SERVICE_URL = process.env.CATALOG_DEL_SERVICE_URL || 'http://34.228.5.25:5011';
// URL del microservicio de imágenes
const IMAGE_SERVICE_URL = process.env.IMAGE_SERVICE_URL || 'http://34.228.5.25:5009';  // Cambia a la URL de tu servicio
